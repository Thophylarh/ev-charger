  ...
  return (
    <div>
      <div className="flex justify-between items-center pt-4">
        <p className="text-gray-400 font-xs font-thin">Ev charger statistics</p>
        <p className="text-gray-400 font-xs font-thin">
          Station energy consumption
        </p>
      </div>
      <div className="grid grid-cols-3 gap-4 pt-4">
        <div className="col-span-2 flex justify-between items-center bg-white p-12">
          <div className="bg-[#FCFCFD] rounded-md p-8 flex flex-col justify-center items-center">
            <div className="pb-8">
          ...
          <div className=" p-8 bg-[#FCFCFD] rounded-md flex flex-col justify-center items-center">
            <div className="pb-8">
