...
{/* 
      ...
      <section className="text-center mt-[1rem]">
        <h1 className="font-bold text-base text-[#101828]">
           {CDetails?.Firstname} {CDetails?.Lastname}
        </h1>

        <h4 className="text-[#667085] font-normal text-[12px]">
          {" "}
          {CDetails?.EmailAddress}
        </h4>
      </section>
      ...
      <section className="mt-[1.25rem]">
        ...
        <div className="flex w-[95%] justify-between mt-[1.5rem] mb-[1rem]" onClick={profiledata}>
            <div className="flex">
